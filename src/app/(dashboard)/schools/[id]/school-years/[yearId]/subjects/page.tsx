// Página de Materias (catálogo compartido, mismo UI que la de escuela)
...
import { BookOpen, Search, Pencil, Plus, X } from "lucide-react";
  ...
  const onSubmit = async (data: SubjectFormData) => {
    ...
    try {
      ...
      if (editingSubject) {
        ...
        // Need school ID for creating — get it from the school year
        await api.post(ENDPOINTS.SUBJECTS, body);
      }
      await fetchSubjects();
